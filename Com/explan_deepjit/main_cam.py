...
if __name__ == '__main__':
    ...
    if params.train is True:
        ...
        print('training data:', len(labels))
        print('cpde', codes[0])
        ...
        id2code_world = get_world_dict(dict_code)
        ...
        if params.cam is True:
            ...
            print('all_msg:', len(all_msg))
            print(all_msg[1], len(all_msg[1]))
            print(mapping_dict_world(all_msg[1][0:100], id2msg_world))
            print(all_msg_mask[1][0:100], sum(all_msg_mask[1]))
            print(all_predict[1])
            print(all_label[1])
            
            for i_i in range(10):
               print(i_i)
               print('code:', all_code[1][i_i][0:100])
               print(mapping_dict_world(all_code[1][i_i][0:100] , id2code_world))
               print(all_code_mask[1][i_i][0:100], sum(all_code_mask[1][i_i]))
